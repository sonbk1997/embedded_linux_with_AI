...
> Software Overview page which presents the
...
#. **Get to know the layer index:**
   All layers can be found in the `layer index <>`. Layers which
...
#. **Never modify the core layers** (**BitBake**, :term:`OpenEmbedded-Core
   (OE-Core)` and possibly meta-yocto ). Never. Ever.
...
#. **Don't be fooled by documentation searching results:**
   ...
   Many developers look through the `All-in-one 'Mega' Manual </singleindex.html>`
...
#. **You can build more than just images:**
   ...
   /brief-yoctoprojectqs/index show how to create an image
...
#. **Depending on what you primary interests are with the Yocto Project, you
   ...
   * **Look Through the Yocto Project Development Tasks Manual**: This manual
     ...
     Project. See the /dev-manual/index.
   ...
   * **Look Through the Yocto Project Application Development and the Extensible
     ...
     application development. The /sdk-manual/extensible also provides
   ...
   * **Learn About Kernel Development**: If you want to see how to work with the
     kernel and understand Yocto Linux kernels, see the /kernel-dev/index.
   ...
   * **Learn About Board Support Packages (BSPs)**: If you want to learn about
     BSPs, see the /bsp-guide/index. This manual also provides an
     example BSP creation workflow. See the /bsp-guide/bsp section.
   ...
   * **Learn About Toaster**: Toaster is a web interface to the Yocto Project's
     ...
     interface to create images, see the /toaster-manual/index.
   ...
   * **Have Available the Yocto Project Reference Manual**: Unlike the rest of
     ...
     structure, classes, and tasks. The /ref-manual/index also
