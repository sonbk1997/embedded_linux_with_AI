...
Alternatively,  you can add `tools-profile` to the **EXTRA_IMAGE_FEATURES** line in
...
outlined in the "profile-manual/intro:General Setup" section.
...
![perf-wget-flat-stripped.png](figures/perf-wget-flat-stripped.png)
...
![perf-wget-g-copy-to-user-expanded-stripped.png](figures/perf-wget-g-copy-to-user-expanded-stripped.png)
...
![perf-wget-g-copy-from-user-expanded-stripped.png](figures/perf-wget-g-copy-from-user-expanded-stripped.png)
...
![perf-wget-busybox-expanded-stripped.png](figures/perf-wget-busybox-expanded-stripped.png)
...
understands, we also need to set **PACKAGE_DEBUG_SPLIT_STYLE**
...
![perf-wget-busybox-debuginfo.png](figures/perf-wget-busybox-debuginfo.png)
...
![perf-wget-busybox-dso-zoom-menu.png](figures/perf-wget-busybox-dso-zoom-menu.png)
...
![perf-wget-busybox-dso-zoom.png](figures/perf-wget-busybox-dso-zoom.png)
...
![perf-wget-g-copy-to-user-expanded-debuginfo.png](figures/perf-wget-g-copy-to-user-expanded-debuginfo.png)
...
![perf-wget-busybox-annotate-menu.png](figures/perf-wget-busybox-annotate-menu.png)
...
![perf-wget-busybox-annotate-udhcpc.png](figures/perf-wget-busybox-annotate-udhcpc.png)
...
![sched-wakeup-profile.png](figures/sched-wakeup-profile.png)
...
![perf-systemwide.png](figures/perf-systemwide.png)
...
![perf-report-cycles-u.png](figures/perf-report-cycles-u.png)
...
![perf-systemwide-libc.png](figures/perf-systemwide-libc.png)
...
![perf-probe-do_fork-profile.png](figures/perf-probe-do_fork-profile.png)
...
![kernelshark-choose-events.png](figures/kernelshark-choose-events.png)
...
![kernelshark-output-display.png](figures/kernelshark-output-display.png)
...
![kernelshark-i915-display.png](figures/kernelshark-i915-display.png)

Here's another example, this time a display resulting from tracing ``all
events``:

![kernelshark-all.png](figures/kernelshark-all.png)
...
`tools-profile` as detailed in the "profile-manual/intro:General Setup"
...
![sysprof-copy-to-user.png](figures/sysprof-copy-to-user.png)
...
![sysprof-copy-from-user.png](figures/sysprof-copy-from-user.png)
...
![sysprof-callers.png](figures/sysprof-callers.png)
...
methods described in the "profile-manual/intro:General Setup" section), you're ready to start
tracing.
...
For this section, we'll assume you've already performed the basic setup
outlined in the "profile-manual/intro:General Setup"
section.
...
"profile-manual/usage:Using blktrace Remotely" section
...
profile-manual/usage:The 'trace events' Subsystem, which
