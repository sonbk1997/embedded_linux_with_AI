...
> **Note:**
> So you've finished the /brief-yoctoprojectqs/index and
> glanced over the document /what-i-wish-id-known, the latter contains
...
#. **Based on the layers you've chosen, make needed changes in your
   ...
   configuration (using the ref-fragments-builtin-core-machine
...
#. **Add a new layer for any custom recipes and metadata you create**.
   ...
   dev-manual/layers:Creating Your Own Layer section.
...
#. **Build your image and refine it**.
   ...
   workflow <sdk-manual/extensible:using \\`devtool\`\` in your sdk
